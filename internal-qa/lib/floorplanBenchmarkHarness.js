...
const ALLOWED_CANDIDATE_METHODS = new Set(["quick_room_baseline", "classical_vision_spike", "manual_seed_spike", "seed_box_spike", "hybrid_selector_spike", "fixture_adapter"]);
