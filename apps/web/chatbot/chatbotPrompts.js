(function () {
  ...
  const COPY = {
    ...
    reviewScope: "A scope review helps catch common gaps: product detail, existing floor removal, disposal, prep, stairs, skirting or scotia, door trimming, furniture, and site details.",
    ...
    routeQuote: "Start with the details you know. Use Not sure where scope needs review, then check the Summary before submitting. Uncertain extras should appear as needs confirmation.",
    ...
    costQuestion: "I cannot calculate pricing here. Start the quote with flooring choice, area, and main inclusions, then Operon confirms the final quote after review.",
    ...
    hiddenCosts: "Clear scope is the best protection against surprises. Removal, disposal, floor preparation, trims, door trimming, furniture, stairs, and site details are the main items worth checking.",
