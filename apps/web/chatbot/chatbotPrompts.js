(function () {
  ...
  const COPY = {
    ...
    quoteExplain: "The quote starts with project basics, then flooring and area, main scope, estimate preview, and contact/submit. The online result is a starting estimate before Operon reviews the scope.",
    priceFactors: "The main scope items are product path, area, stairs, existing floor removal, disposal, floor preparation, underlay, trims, moisture protection, door trimming, furniture, and notes.",
    ...
    routeQuote: "Start with the details you know. Use Not sure where the site needs review; contact details are completed at submit.",
