-- Operon Flooring Supabase safe cleanup
-- Prepared: 2026-05-04
--
-- Purpose:
-- 1. Create the missing quote_reviews table used by netlify/functions/save-quote-review.js.
-- 2. Remove only empty, unwired archive-candidate tables.
--
-- Safety notes:
-- - This script intentionally does NOT use CASCADE.
-- - If any table has an unexpected dependency, Supabase/Postgres should block the drop.
-- - This script does NOT touch live pricing, product, quote request, tracking, or non-empty historical tables.
-- - Non-empty tables customers, quotes, and quotes_public_view were exported before cleanup.
-- - quote_leads is NOT dropped because quote_reviews currently references it.
