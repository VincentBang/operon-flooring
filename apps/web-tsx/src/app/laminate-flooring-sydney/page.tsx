        ...
        <div className="shell grid-2">
          <article className="section-card">
            ...
            <div className="link-grid">
              ...
              <a className="link-card" href={routes.roomVisualiser}><strong>Laminate flooring visualiser</strong><span>Preview a lighter laminate direction before quoting.</span></a>
            </div>
          </article>
          <article className="section-card">
