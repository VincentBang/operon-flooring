(function () {
  ...
  const QUOTE_FLOW = {
    key: "quote_flow",
    label: "Quote flow",
    summary: "The customer quote path is a five-step express flow: Project basics, Flooring and area, Main scope, Estimate preview, then Contact and submit. Advanced scope details remain available from the estimate step, and the online result is a starting estimate, not the final confirmed quote.",
    steps: ["project_basics", "flooring_area", "main_scope", "estimate_preview", "contact_submit"],
    route: { label: "Start quote", href: "quote.html" },
    terms: ["quote flow", "how quote works", "quote process", "project basics", "flooring and area", "main scope", "estimate preview", "contact submit", "not sure", "estimate", "submit", "email copy", "email me a copy", "quote submitted"]
  };
