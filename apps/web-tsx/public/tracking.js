(function () {
  ...
  const GA_EVENT_ALIASES = {
    ...
    quote_review_upload_success: "quote_review_upload_succeeded",
    quote_review_upload_failed: "quote_review_upload_failed",
    quote_review_report_viewed: "quote_review_report_viewed",
    quote_review_email_send_attempt: "quote_review_email_send_attempt",
    quote_review_email_send_success: "quote_review_email_send_success",
    quote_review_email_send_failed: "quote_review_email_send_failed",
    // Legacy alias only normalizes older callers; quote-review now emits quote_review_to_quote_clicked directly.
